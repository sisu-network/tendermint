...
import (
	...
	tmcon "github.com/sisu-network/tendermint/consensus"
	...
	"github.com/sisu-network/tendermint/libs/fail"
...
func (cs *State) handleMsg(mi msgInfo) {
	...
	case *tmcon.VoteMessage:
		...
		// a typical peer.
		// https://github.com/sisu-network/tendermint/issues/1281
		// }
...
func (cs *State) tryAddVote(vote *types.Vote, peerID p2p.ID) (bool, error) {
	...
	if err != nil {
		...
		if voteErr, ok := err.(*types.ErrVoteConflictingVotes); ok {
			...
			// 		(https://github.com/sisu-network/tendermint/issues/3839).
