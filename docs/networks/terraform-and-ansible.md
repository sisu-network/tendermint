...
script](https://github.com/sisu-network/tendermint/blob/master/networks/remote/integration.sh)
...
directory](https://github.com/sisu-network/tendermint/tree/master/networks/remote/ansible)
