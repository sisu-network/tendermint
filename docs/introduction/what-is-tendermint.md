...
(ABCI)](https://github.com/sisu-network/tendermint/tree/master/abci)
...
[Tendermint Core](https://github.com/sisu-network/tendermint) (the
...
Types](https://github.com/sisu-network/tendermint/blob/master/abci/README.md#message-types).
