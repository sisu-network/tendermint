...
import (
	...
	cryptoenc "github.com/sisu-network/tendermint/crypto/encoding"
	"github.com/sisu-network/tendermint/libs/async"
	"github.com/sisu-network/tendermint/libs/protoio"
	tmsync "github.com/sisu-network/tendermint/libs/sync"
	tmp2p "github.com/sisu-network/tendermint/proto/tendermint/p2p"
)
...
// See https://github.com/sisu-network/tendermint/blob/0.1/docs/sts-final.pdf for
...
// (TODO(ismail): see also https://github.com/sisu-network/tendermint/issues/3010)
...
func incrNonce(nonce *[aeadNonceSize]byte) {
	...
	if counter == math.MaxUint64 {
		...
		// See https://github.com/sisu-network/tendermint/issues/3531
